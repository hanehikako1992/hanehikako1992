            ...
            <div id="menu">
              <ul className="list-group">
                <li className="list-group-item">
                  ...
                  <a className="item active" onClick={connect}>Register</a>
                  }
                ...
                <div className="modal-content">
                  ...
                  <div className="modal-body">
                    ...
                    <div className="m-social-icons">
                      <a className="p-2" target="_blank" href="https://instagram.com/meta3oys"> <img alt="twitter" src={twitter} /><img alt="twitter" src={twitterh} /> </a>
                      <a className="p-2" target="_blank" href="https://twitter.com/meta3oys"> <img alt="twitter" src={vec2} /><img alt="twitter" src={vec2h} /> </a>
                      <a className="p-2" target="_blank" href="https://opensea.io/collection/meta3oys"> <img alt="twitter" src={vec3} /><img alt="twitter" src={vec3h} /> </a>
                      <a className="p-2 disabled" target="_blank" href="https://discord.gg/meta3oys"> <img alt="twitter" src={vec4} /><img alt="twitter" src={vec4h} /> </a>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="row desc">
          <div className="col-10 text-left">
            ...
            <p className="p-header-title">
              NFT collection of 7777 fashion boys categorized in different levels of rarity
            </p></FadeIn>
